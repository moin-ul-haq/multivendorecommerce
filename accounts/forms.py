...
class SignUpForm(forms.ModelForm):
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'input_box'}))
    password2 = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'input_box'}))
    role = forms.ChoiceField(choices=[('customer', 'Customer'), ('owner', 'Owner')], widget=forms.Select(attrs={'class': 'input_box'}))
