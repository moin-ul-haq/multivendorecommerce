...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    sub_total = serializers.DecimalField(source='get_sub_total', max_digits=12, decimal_places=2, read_only=True)

    class Meta:
        model = CartItem
        fields = ['id', 'product', 'product_name', 'product_slug', 'quantity', 'unit_price', 'sub_total']
